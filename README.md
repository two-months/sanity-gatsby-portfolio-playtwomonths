# sanity-gatsby-portfolio-playtwomonths
...
1. Go to your [project’s API settings on manage.sanity.io](https://manage.sanity.io/projects/3vdq3jay/settings/api) and create a token with read rights.
